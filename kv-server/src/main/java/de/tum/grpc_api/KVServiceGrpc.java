...
public final class KVServiceGrpc {
				...
				if ((getIsResponsibleMethod = KVServiceGrpc.getIsResponsibleMethod) == null) {
					KVServiceGrpc.getIsResponsibleMethod = getIsResponsibleMethod =
						io.grpc.MethodDescriptor.<de.tum.grpc_api.KVServerProto.IsResponsibleRequest, de.tum.grpc_api.KVServerProto.IsResponsibleResponse>newBuilder()
							.setType(io.grpc.MethodDescriptor.MethodType.UNARY)
							.setFullMethodName(
								generateFullMethodName(SERVICE_NAME, "isResponsible"))
							.setSampledToLocalTracing(true)
							.setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
							...
							.setSchemaDescriptor(
								new KVServiceMethodDescriptorSupplier("isResponsible"))
							.build();
				}
			}
		}
	...
	private static volatile io.grpc.MethodDescriptor<de.tum.grpc_api.KVServerProto.PutBackupRequest,
		com.google.protobuf.Empty> getPutBackupMethod;

	@io.grpc.stub.annotations.RpcMethod(
		fullMethodName = SERVICE_NAME + '/' + "putBackup",
		requestType = de.tum.grpc_api.KVServerProto.PutBackupRequest.class,
		responseType = com.google.protobuf.Empty.class,
		methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
	public static io.grpc.MethodDescriptor<de.tum.grpc_api.KVServerProto.PutBackupRequest,
		com.google.protobuf.Empty> getPutBackupMethod() {
		io.grpc.MethodDescriptor<de.tum.grpc_api.KVServerProto.PutBackupRequest, com.google.protobuf.Empty> getPutBackupMethod;
		if ((getPutBackupMethod = KVServiceGrpc.getPutBackupMethod) == null) {
			synchronized (KVServiceGrpc.class) {
				if ((getPutBackupMethod = KVServiceGrpc.getPutBackupMethod) == null) {
					KVServiceGrpc.getPutBackupMethod = getPutBackupMethod =
						io.grpc.MethodDescriptor.<de.tum.grpc_api.KVServerProto.PutBackupRequest, com.google.protobuf.Empty>newBuilder()
							.setType(io.grpc.MethodDescriptor.MethodType.UNARY)
							.setFullMethodName(generateFullMethodName(SERVICE_NAME, "putBackup"))
							.setSampledToLocalTracing(true)
							.setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
								de.tum.grpc_api.KVServerProto.PutBackupRequest.getDefaultInstance()))
							.setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
								com.google.protobuf.Empty.getDefaultInstance()))
	...
	public static io.grpc.MethodDescriptor<de.tum.grpc_api.KVServerProto.ExecuteTransactionsRequest,
		...
		if ((getExecuteTransactionsMethod = KVServiceGrpc.getExecuteTransactionsMethod) == null) {
			synchronized (KVServiceGrpc.class) {
				if ((getExecuteTransactionsMethod = KVServiceGrpc.getExecuteTransactionsMethod)
					== null) {
					KVServiceGrpc.getExecuteTransactionsMethod = getExecuteTransactionsMethod =
						io.grpc.MethodDescriptor.<de.tum.grpc_api.KVServerProto.ExecuteTransactionsRequest, de.tum.grpc_api.KVServerProto.ExecuteTransactionsResponse>newBuilder()
							.setType(io.grpc.MethodDescriptor.MethodType.UNARY)
							.setFullMethodName(
								generateFullMethodName(SERVICE_NAME, "executeTransactions"))
							.setSampledToLocalTracing(true)
							.setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
							...
							.setSchemaDescriptor(
								new KVServiceMethodDescriptorSupplier("executeTransactions"))
							.build();
				}
			}
		}
				...
				if ((getStartKVServerMethod = KVServiceGrpc.getStartKVServerMethod) == null) {
					KVServiceGrpc.getStartKVServerMethod = getStartKVServerMethod =
						io.grpc.MethodDescriptor.<com.google.protobuf.Empty, com.google.protobuf.Empty>newBuilder()
							.setType(io.grpc.MethodDescriptor.MethodType.UNARY)
							.setFullMethodName(
								generateFullMethodName(SERVICE_NAME, "startKVServer"))
							.setSampledToLocalTracing(true)
							.setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
								com.google.protobuf.Empty.getDefaultInstance()))
							.setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
								com.google.protobuf.Empty.getDefaultInstance()))
							.setSchemaDescriptor(
								new KVServiceMethodDescriptorSupplier("startKVServer"))
							.build();
				}
			}
		}
					...
					KVServiceGrpc.getUpdateRingMethod = getUpdateRingMethod =
						io.grpc.MethodDescriptor.<de.tum.grpc_api.KVServerProto.UpdateRingRequest, com.google.protobuf.Empty>newBuilder()
							...
							.setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
								com.google.protobuf.Empty.getDefaultInstance()))
							.setSchemaDescriptor(
								new KVServiceMethodDescriptorSupplier("updateRing"))
							.build();
				}
			}
		}
	...
	public static io.grpc.MethodDescriptor<de.tum.grpc_api.KVServerProto.DeleteExpiredDataRequest,
		...
		if ((getDeleteExpiredDataMethod = KVServiceGrpc.getDeleteExpiredDataMethod) == null) {
			synchronized (KVServiceGrpc.class) {
				if ((getDeleteExpiredDataMethod = KVServiceGrpc.getDeleteExpiredDataMethod)
					== null) {
					KVServiceGrpc.getDeleteExpiredDataMethod = getDeleteExpiredDataMethod =
						io.grpc.MethodDescriptor.<de.tum.grpc_api.KVServerProto.DeleteExpiredDataRequest, com.google.protobuf.Empty>newBuilder()
							.setType(io.grpc.MethodDescriptor.MethodType.UNARY)
							.setFullMethodName(
								generateFullMethodName(SERVICE_NAME, "deleteExpiredData"))
							.setSampledToLocalTracing(true)
							.setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
							...
							.setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
								com.google.protobuf.Empty.getDefaultInstance()))
							.setSchemaDescriptor(
								new KVServiceMethodDescriptorSupplier("deleteExpiredData"))
							.build();
				}
			}
		}
	...
	public static KVServiceStub newStub(io.grpc.Channel channel) {
		io.grpc.stub.AbstractStub.StubFactory<KVServiceStub> factory =
			new io.grpc.stub.AbstractStub.StubFactory<KVServiceStub>() {
				@java.lang.Override
				public KVServiceStub newStub(io.grpc.Channel channel,
	...
	public static KVServiceBlockingStub newBlockingStub(
		...
		io.grpc.stub.AbstractStub.StubFactory<KVServiceBlockingStub> factory =
			new io.grpc.stub.AbstractStub.StubFactory<KVServiceBlockingStub>() {
				@java.lang.Override
				public KVServiceBlockingStub newStub(io.grpc.Channel channel,
					io.grpc.CallOptions callOptions) {
	...
	public static KVServiceFutureStub newFutureStub(
		...
		io.grpc.stub.AbstractStub.StubFactory<KVServiceFutureStub> factory =
			new io.grpc.stub.AbstractStub.StubFactory<KVServiceFutureStub>() {
				@java.lang.Override
				public KVServiceFutureStub newStub(io.grpc.Channel channel,
					io.grpc.CallOptions callOptions) {
	...
	public interface AsyncService {
		...
		default void heartBeat(com.google.protobuf.Empty request,
			...
			io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getHeartBeatMethod(),
				responseObserver);
		}
		...
		default void getRange(de.tum.grpc_api.KVServerProto.GetRangeRequest request,
			...
			io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetRangeMethod(),
				responseObserver);
		}
		...
		default void equals(com.google.protobuf.Empty request,
			...
			io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getEqualsMethod(),
				responseObserver);
		}
		...
		default void toString(com.google.protobuf.Empty request,
			...
			io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getToStringMethod(),
				responseObserver);
		}
		...
		default void isResponsible(de.tum.grpc_api.KVServerProto.IsResponsibleRequest request,
			...
			io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getIsResponsibleMethod(),
				responseObserver);
		}
		 ...
		 *
		 */
		default void putBackup(de.tum.grpc_api.KVServerProto.PutBackupRequest request,
			io.grpc.stub.StreamObserver<com.google.protobuf.Empty> responseObserver) {
			io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getPutBackupMethod(),
				responseObserver);
		}
		...
		default void delete(de.tum.grpc_api.KVServerProto.DeleteRequest request,
			io.grpc.stub.StreamObserver<com.google.protobuf.Empty> responseObserver) {
			io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getDeleteMethod(),
				responseObserver);
		}
		...
		default void hasKey(de.tum.grpc_api.KVServerProto.HasKeyRequest request,
			...
			io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getHasKeyMethod(),
				responseObserver);
		}
		 ...
		 *
		 */
		default void executeTransactions(
			...
			io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getExecuteTransactionsMethod(),
				responseObserver);
		}
		...
		default void rollBack(de.tum.grpc_api.KVServerProto.RollbackRequest request,
			io.grpc.stub.StreamObserver<com.google.protobuf.Empty> responseObserver) {
			io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getRollBackMethod(),
				responseObserver);
		}
		...
		default void unlockAll(de.tum.grpc_api.KVServerProto.unlockAllRequest request,
			io.grpc.stub.StreamObserver<com.google.protobuf.Empty> responseObserver) {
			io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getUnlockAllMethod(),
				responseObserver);
		}
		...
		default void startKVServer(com.google.protobuf.Empty request,
			io.grpc.stub.StreamObserver<com.google.protobuf.Empty> responseObserver) {
			io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getStartKVServerMethod(),
				responseObserver);
		}
		...
		default void recover(de.tum.grpc_api.KVServerProto.RecoverRequest request,
			io.grpc.stub.StreamObserver<com.google.protobuf.Empty> responseObserver) {
			io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getRecoverMethod(),
				responseObserver);
		}
		...
		default void updateRing(de.tum.grpc_api.KVServerProto.UpdateRingRequest request,
			io.grpc.stub.StreamObserver<com.google.protobuf.Empty> responseObserver) {
			io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getUpdateRingMethod(),
				responseObserver);
		}
		 ...
		 *
		 */
		default void deleteExpiredData(
			de.tum.grpc_api.KVServerProto.DeleteExpiredDataRequest request,
			io.grpc.stub.StreamObserver<com.google.protobuf.Empty> responseObserver) {
			io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getDeleteExpiredDataMethod(),
				responseObserver);
		}
	}
	...
	public static final class KVServiceBlockingStub
		 ...
		 *
		 */
		public de.tum.grpc_api.KVServerProto.HeartBeatResponse heartBeat(
		 ...
		 *
		 */
		public de.tum.grpc_api.KVServerProto.GetRangeResponse getRange(
		 ...
		 *
		 */
		public de.tum.grpc_api.KVServerProto.ToStringResponse toString(
			com.google.protobuf.Empty request) {
			return io.grpc.stub.ClientCalls.blockingUnaryCall(
		 ...
		 * </pre>
		 */
		public de.tum.grpc_api.KVServerProto.IsResponsibleResponse isResponsible(
		 ...
		 *
		 */
		public de.tum.grpc_api.KVServerProto.CopyResponse copy(
		 ...
		 *
		 */
		public de.tum.grpc_api.KVServerProto.GetResponse get(
		 ...
		 *
		 */
		public com.google.protobuf.Empty putBackup(
			de.tum.grpc_api.KVServerProto.PutBackupRequest request) {
			return io.grpc.stub.ClientCalls.blockingUnaryCall(
		 ...
		 *
		 */
		public com.google.protobuf.Empty delete(
		 ...
		 *
		 */
		public de.tum.grpc_api.KVServerProto.HasKeyResponse hasKey(
		 ...
		 *
		 */
		public de.tum.grpc_api.KVServerProto.ExecuteTransactionsResponse executeTransactions(
			de.tum.grpc_api.KVServerProto.ExecuteTransactionsRequest request) {
			return io.grpc.stub.ClientCalls.blockingUnaryCall(
		 ...
		 *
		 */
		public com.google.protobuf.Empty unlockAll(
		 ...
		 *
		 */
		public com.google.protobuf.Empty recover(
		 ...
		 *
		 */
		public com.google.protobuf.Empty updateRing(
		 ...
		 *
		 */
		public com.google.protobuf.Empty deleteExpiredData(
			de.tum.grpc_api.KVServerProto.DeleteExpiredDataRequest request) {
			return io.grpc.stub.ClientCalls.blockingUnaryCall(
	...
	private static final int METHODID_UPDATE_RING = 17;
	private static final int METHODID_DELETE_EXPIRED_DATA = 18;
		...
		public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
			switch (methodId) {
				...
				case METHODID_PUT_BACKUP:
					serviceImpl.putBackup((de.tum.grpc_api.KVServerProto.PutBackupRequest) request,
						(io.grpc.stub.StreamObserver<com.google.protobuf.Empty>) responseObserver);
					break;
				...
				case METHODID_EXECUTE_TRANSACTIONS:
					serviceImpl.executeTransactions(
						(de.tum.grpc_api.KVServerProto.ExecuteTransactionsRequest) request,
						(io.grpc.stub.StreamObserver<de.tum.grpc_api.KVServerProto.ExecuteTransactionsResponse>) responseObserver);
					break;
				...
				case METHODID_UPDATE_RING:
					serviceImpl.updateRing(
						(de.tum.grpc_api.KVServerProto.UpdateRingRequest) request,
						(io.grpc.stub.StreamObserver<com.google.protobuf.Empty>) responseObserver);
					break;
				case METHODID_DELETE_EXPIRED_DATA:
					serviceImpl.deleteExpiredData(
						(de.tum.grpc_api.KVServerProto.DeleteExpiredDataRequest) request,
						(io.grpc.stub.StreamObserver<com.google.protobuf.Empty>) responseObserver);
					break;
				default:
	...
	public static final io.grpc.ServerServiceDefinition bindService(AsyncService service) {
		return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
			...
			.addMethod(
				...
				io.grpc.stub.ServerCalls.asyncUnaryCall(
					new MethodHandlers<
						de.tum.grpc_api.KVServerProto.PutBackupRequest,
						com.google.protobuf.Empty>(
