...
public final class ECServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<de.tum.grpc_api.KVServerProto.RegisterRequest,
      com.google.protobuf.Empty> getRegisterMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "register",
      requestType = de.tum.grpc_api.KVServerProto.RegisterRequest.class,
      responseType = com.google.protobuf.Empty.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<de.tum.grpc_api.KVServerProto.RegisterRequest,
      com.google.protobuf.Empty> getRegisterMethod() {
    io.grpc.MethodDescriptor<de.tum.grpc_api.KVServerProto.RegisterRequest, com.google.protobuf.Empty> getRegisterMethod;
      ...
      synchronized (ECServiceGrpc.class) {
        if ((getRegisterMethod = ECServiceGrpc.getRegisterMethod) == null) {
          ECServiceGrpc.getRegisterMethod = getRegisterMethod =
              io.grpc.MethodDescriptor.<de.tum.grpc_api.KVServerProto.RegisterRequest, com.google.protobuf.Empty>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "register"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  de.tum.grpc_api.KVServerProto.RegisterRequest.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void register(de.tum.grpc_api.KVServerProto.RegisterRequest request,
  ...
  public static final class ECServiceStub
    ...
    /**
     */
    public void register(de.tum.grpc_api.KVServerProto.RegisterRequest request,
        io.grpc.stub.StreamObserver<com.google.protobuf.Empty> responseObserver) {
  ...
  public static final class ECServiceBlockingStub
    ...
    /**
     */
    public com.google.protobuf.Empty register(de.tum.grpc_api.KVServerProto.RegisterRequest request) {
  ...
  public static final class ECServiceFutureStub
    ...
    public com.google.common.util.concurrent.ListenableFuture<com.google.protobuf.Empty> register(
        de.tum.grpc_api.KVServerProto.RegisterRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_REGISTER:
          serviceImpl.register((de.tum.grpc_api.KVServerProto.RegisterRequest) request,
              (io.grpc.stub.StreamObserver<com.google.protobuf.Empty>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              de.tum.grpc_api.KVServerProto.RegisterRequest,
