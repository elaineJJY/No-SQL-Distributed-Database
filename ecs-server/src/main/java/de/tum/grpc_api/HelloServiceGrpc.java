...
public final class HelloServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<grpc_api.ECSProto.HelloRequest,
      grpc_api.ECSProto.HelloResponse> getHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "hello",
      requestType = grpc_api.ECSProto.HelloRequest.class,
      responseType = grpc_api.ECSProto.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<grpc_api.ECSProto.HelloRequest,
      grpc_api.ECSProto.HelloResponse> getHelloMethod() {
    io.grpc.MethodDescriptor<grpc_api.ECSProto.HelloRequest, grpc_api.ECSProto.HelloResponse> getHelloMethod;
    if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
          HelloServiceGrpc.getHelloMethod = getHelloMethod =
              io.grpc.MethodDescriptor.<grpc_api.ECSProto.HelloRequest, grpc_api.ECSProto.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "hello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc_api.ECSProto.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc_api.ECSProto.HelloResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void hello(grpc_api.ECSProto.HelloRequest request,
        io.grpc.stub.StreamObserver<grpc_api.ECSProto.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceBlockingStub
    ...
    /**
     */
    public grpc_api.ECSProto.HelloResponse hello(grpc_api.ECSProto.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc_api.ECSProto.HelloResponse> hello(
        grpc_api.ECSProto.HelloRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((grpc_api.ECSProto.HelloRequest) request,
              (io.grpc.stub.StreamObserver<grpc_api.ECSProto.HelloResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              grpc_api.ECSProto.HelloRequest,
              grpc_api.ECSProto.HelloResponse>(
