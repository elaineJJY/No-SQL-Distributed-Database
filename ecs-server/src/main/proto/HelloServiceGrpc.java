...
public final class HelloServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<de.tum.ECSProto.HelloRequest,
      de.tum.ECSProto.HelloResponse> getHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "hello",
      requestType = de.tum.ECSProto.HelloRequest.class,
      responseType = de.tum.ECSProto.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<de.tum.ECSProto.HelloRequest,
      de.tum.ECSProto.HelloResponse> getHelloMethod() {
    io.grpc.MethodDescriptor<de.tum.ECSProto.HelloRequest, de.tum.ECSProto.HelloResponse> getHelloMethod;
    if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
          HelloServiceGrpc.getHelloMethod = getHelloMethod =
              io.grpc.MethodDescriptor.<de.tum.ECSProto.HelloRequest, de.tum.ECSProto.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "hello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  de.tum.ECSProto.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  de.tum.ECSProto.HelloResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void hello(de.tum.ECSProto.HelloRequest request,
        io.grpc.stub.StreamObserver<de.tum.ECSProto.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceStub
    ...
    /**
     */
    public void hello(de.tum.ECSProto.HelloRequest request,
        io.grpc.stub.StreamObserver<de.tum.ECSProto.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceBlockingStub
    ...
    /**
     */
    public de.tum.ECSProto.HelloResponse hello(de.tum.ECSProto.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<de.tum.ECSProto.HelloResponse> hello(
        de.tum.ECSProto.HelloRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((de.tum.ECSProto.HelloRequest) request,
              (io.grpc.stub.StreamObserver<de.tum.ECSProto.HelloResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              de.tum.ECSProto.HelloRequest,
              de.tum.ECSProto.HelloResponse>(
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return de.tum.ECSProto.getDescriptor();
    }
